...
__all__ = [
    ...
    #"fasterrcnn_resnet50_fpn_v2", #added by mau
]
...
model_urls = {
    ...
    #'fasterrcnn_resnet50_fpn_v2':'https://download.pytorch.org/models/fasterrcnn_resnet50_fpn_v2_coco-dd69338a.pth'
}
...
def fasterrcnn_resnet_fpn(backbone_name: str, pretrained=False, progress=True,
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(
            ...
            progress=progress)
        model.load_state_dict(torch.load('/home/mauricio/Documents/Pytorch/Pre-processing_model/_runs/Resnet50_All_data/adaptive_thres_morpho2/segment-fold2/model_best.pth'))
