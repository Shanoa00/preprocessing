...
def main():
    ...
    detalle= args.detailed[:-1] #added
    print("AAAA",(detalle)) #added
    #dfs = [pd.read_csv(path) for path in detalle] #original
    dfs = [pd.read_csv(path) for path in detalle]
...
"""
100%|█████████████████████████████████████████████████████████████████████████| 395579/395579 [00:54<00:00, 7276.62it/s]
78.3% predictions kept
"""