...
def main():
    ...
    arg('--print-model', default=0, type=int)
    ...
    print('Loading data')
    df_train_gt, df_valid_gt = load_train_valid_df(args.fold, args.n_folds) #original training dataset
    df_clf_gt = load_train_df(args.clf_gt)[['labels', 'image_id']] #Predicted ground true_ segmentation
    #df_clf_gt.to_excel("clasf_df_clf_gt.xlsx")
    # stop=1
    # if stop:
    ...
    if args.submission:
        ...
        # df_train.to_excel("clasf_df_train.xlsx")
        # df_valid.to_excel("clasf_df_val.xlsx")
        # stop=1
        # if stop:
        #     wait = input("Press Enter to continue....")
        #     sys.exit()
